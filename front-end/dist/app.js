(() => {
  ...
  var HomePage = class extends HTMLElement {
    connectedCallback() {
      this.currentUser = null;
  ...
  var DeliveryPage = class extends HTMLElement {
    constructor() {
      super();
  ...
  var OrdersPage = class extends HTMLElement {
    connectedCallback() {
  ...
  var ProfilePage = class extends HTMLElement {
    connectedCallback() {
  ...
  var PayPage = class extends HTMLElement {
    connectedCallback() {
      this.handleRouteChange = this.handleRouteChange.bind(this);
      window.addEventListener("hashchange", this.handleRouteChange);
      this.handleRouteChange();
  ...
  var LoginPage = class extends HTMLElement {
    connectedCallback() {
  ...
  var ShCart = class extends HTMLElement {
    constructor() {
      super();
      this.prices = {
        "\u041A\u0438\u043C\u0431\u0430\u0431": 5500,
  ...
  var OfferCard = class extends HTMLElement {
  ...
  var OffersList = class extends HTMLElement {
    connectedCallback() {
      if (this._ready) return;
      this._ready = true;
      this.render();
  ...
  var DeliveryCart = class extends HTMLElement {
    connectedCallback() {
  ...
  var OfferModal = class extends HTMLElement {
    constructor() {
      super();
      this.attachShadow({ mode: "open" });
    }
  ...
  var ConfirmModal = class extends HTMLElement {
    constructor() {
      super();
      this.attachShadow({ mode: "open" });
    }
  ...
  var OrderConfirm = class extends HTMLElement {
    constructor() {
      super();
      this.pendingOrder = null;
      this.pendingOffer = null;
  ...
  var DOrders = class extends HTMLElement {
    connectedCallback() {
  ...
  var DelOrderDetails = class extends HTMLElement {
    connectedCallback() {
      this.renderEmpty();
  ...
  var DelOrderProgress = class extends HTMLElement {
    connectedCallback() {
  ...
  var PersonDetail = class extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
  ...
  var API2 = "http://localhost:3000";
  var Couriers = class extends HTMLElement {
    connectedCallback() {
      this.render();
      this.loadCourier();
    }
  ...
  var RatingStars = class extends HTMLElement {
    constructor() {
      super();
      this.attachShadow({ mode: "open" });
      this.value = 0;
