(()=>{var Ee=window.fetch.bind(window);window.fetch=(o,e={})=>{e.headers||(e.headers={});let t=new Headers(e.headers);return Ee(o,{credentials:"include",...e,headers:t})};var $=class extends HTMLElement{connectedCallback(){this.render=this.render.bind(this),this.updateActive=this.updateActive.bind(this),this.handleDocClick=this.handleDocClick.bind(this),this.handleUserUpdated=this.handleUserUpdated.bind(this),this.handleAppStateChanged=this.handleAppStateChanged.bind(this),this.loadUser=this.loadUser.bind(this),this.scheduleIdle=this.scheduleIdle?.bind(this)||(e=>{typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>e(),{timeout:1200}):setTimeout(e,300)}),this.render(),window.addEventListener("hashchange",this.updateActive),window.addEventListener("user-updated",this.handleUserUpdated),window.addEventListener("app-state-changed",this.handleAppStateChanged),this.scheduleIdle(this.loadUser),this.updateActive()}disconnectedCallback(){window.removeEventListener("hashchange",this.updateActive),window.removeEventListener("user-updated",this.handleUserUpdated),window.removeEventListener("app-state-changed",this.handleAppStateChanged),document.removeEventListener("click",this.handleDocClick)}getAppState(){let e=localStorage.getItem("appState");if(e==="customer"||e==="courier")return e;let t=localStorage.getItem("authRole");return t==="customer"||t==="courier"?t:"guest"}getNavLinks(){let e=this.getAppState(),t=[];return e==="customer"&&(t.push({href:"#home",label:"\u041D\u04AF\u04AF\u0440",icon:"home"}),t.push({href:"#orders",label:"\u0417\u0430\u0445\u0438\u0430\u043B\u0433\u0430",icon:"orders"})),e==="courier"&&(t.push({href:"#home",label:"\u041D\u04AF\u04AF\u0440",icon:"home"}),t.push({href:"#delivery",label:"\u0425\u04AF\u0440\u0433\u044D\u043B\u0442",icon:"delivery"})),e!=="guest"&&t.push({href:"#profile",label:"\u041F\u0440\u043E\u0444\u0430\u0439\u043B",icon:"profile"}),t}renderNavLinks(){return this.getNavLinks().map(t=>`
  ...
  <div class="scene">
    ...
    `}updateToNow(){let e=this.shadowRoot.querySelector(".date"),t=this.shadowRoot.querySelector(".time"),r=new Date,i=r.getFullYear(),s=String(r.getMonth()+1).padStart(2,"0"),a=String(r.getDate()).padStart(2,"0"),n=String(r.getHours()).padStart(2,"0"),d=String(r.getMinutes()).padStart(2,"0");e.value=`${i}-${s}-${a}`,t.value=`${n}:${d}`}startAutoUpdate(){this._timer=setInterval(()=>{this.updateToNow()},1e3*30)}get value(){let e=this.shadowRoot.querySelector(".date").value,t=this.shadowRoot.querySelector(".time").value;return`${e} \u2022 ${t}`}};customElements.define("date-time-picker",P);var j=class extends HTMLElement{constructor(){super(),this.prices={\u041A\u0438\u043C\u0431\u0430\u0431:5500,\u0411\u0443\u0440\u0433\u0435\u0440:6500,\u0411\u0443\u0443\u0437:4e3,\u0421\u0430\u043B\u0430\u0434:3e3,"\u041A\u043E\u043B\u0430 0.5\u043B":2500,"\u0425\u0430\u0440 \u0446\u0430\u0439":1500,\u041A\u043E\u0444\u0435:3e3,"\u0416\u04AF\u04AF\u0441 0.33\u043B":2500},this.deliveryIcons={single:"assets/img/document.svg",medium:"assets/img/tor.svg",large:"assets/img/box.svg"}}connectedCallback(){this.render(),this.initializeElements(),this.setupEventListeners(),this.updateTotalsAndCount()}render(){this.innerHTML=`
          <h3>\u0422\u0430\u043D\u044B \u0441\u0430\u0433\u0441</h3>
          <div class="cart-icon">
    ...
    `}attach(){this.addEventListener("click",()=>{let e=this.data;this.dispatchEvent(new CustomEvent("offer-select",{bubbles:!0,detail:e}))}),this.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.click())})}};customElements.get("offer-card")||customElements.define("offer-card",B);var F=class extends HTMLElement{connectedCallback(){this._ready||(this._ready=!0,this._loaded=!1,this.handleRouteChange=this.handleRouteChange?.bind(this)||(()=>this.onRouteChange()),this.render(),this.handleOffersUpdated=()=>he(),window.addEventListener("offers-updated",this.handleOffersUpdated),window.addEventListener("hashchange",this.handleRouteChange),this.addEventListener("offer-select",this.handleOfferSelect),this.handleRouteChange())}disconnectedCallback(){this.handleOffersUpdated&&window.removeEventListener("offers-updated",this.handleOffersUpdated),window.removeEventListener("hashchange",this.handleRouteChange),this.removeEventListener("offer-select",this.handleOfferSelect)}render(){this.innerHTML=`
