(()=>{var Oe=window.fetch.bind(window);window.fetch=(o,e={})=>{e.headers||(e.headers={});let t=new Headers(e.headers);return Oe(o,{credentials:"include",...e,headers:t})};var $=class extends HTMLElement{connectedCallback(){this.render=this.render.bind(this),this.updateActive=this.updateActive.bind(this),this.handleDocClick=this.handleDocClick.bind(this),this.handleUserUpdated=this.handleUserUpdated.bind(this),this.handleAppStateChanged=this.handleAppStateChanged.bind(this),this.loadUser=this.loadUser.bind(this),this.scheduleIdle=this.scheduleIdle?.bind(this)||(e=>{typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>e(),{timeout:1200}):setTimeout(e,300)}),this.render(),window.addEventListener("hashchange",this.updateActive),window.addEventListener("user-updated",this.handleUserUpdated),window.addEventListener("app-state-changed",this.handleAppStateChanged),this.scheduleIdle(this.loadUser),this.updateActive()}disconnectedCallback(){window.removeEventListener("hashchange",this.updateActive),window.removeEventListener("user-updated",this.handleUserUpdated),window.removeEventListener("app-state-changed",this.handleAppStateChanged),document.removeEventListener("click",this.handleDocClick)}getAppState(){let e=localStorage.getItem("appState");if(e==="customer"||e==="courier")return e;let t=localStorage.getItem("authRole");return t==="customer"||t==="courier"?t:"guest"}getNavLinks(){let e=this.getAppState(),t=[];return e==="customer"&&(t.push({href:"#home",label:"\u041D\u04AF\u04AF\u0440",icon:"home"}),t.push({href:"#orders",label:"\u0417\u0430\u0445\u0438\u0430\u043B\u0433\u0430",icon:"orders"})),e==="courier"&&(t.push({href:"#home",label:"\u041D\u04AF\u04AF\u0440",icon:"home"}),t.push({href:"#delivery",label:"\u0425\u04AF\u0440\u0433\u044D\u043B\u0442",icon:"delivery"})),e!=="guest"&&t.push({href:"#profile",label:"\u041F\u0440\u043E\u0444\u0430\u0439\u043B",icon:"profile"}),t}renderNavLinks(){return this.getNavLinks().map(t=>`
  ...
  <div class="scene">
    ...
    `}attach(){this.addEventListener("click",()=>{let e=this.data;this.dispatchEvent(new CustomEvent("offer-select",{bubbles:!0,detail:e}))}),this.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.click())})}};customElements.get("offer-card")||customElements.define("offer-card",B);function F(o){return String(o??"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var J=class extends HTMLElement{connectedCallback(){this._ready||(this._ready=!0,this._loaded=!1,this.handleRouteChange=this.handleRouteChange?.bind(this)||(()=>this.onRouteChange()),this.render(),this.handleOffersUpdated=()=>pe(),window.addEventListener("offers-updated",this.handleOffersUpdated),window.addEventListener("hashchange",this.handleRouteChange),this.addEventListener("offer-select",this.handleOfferSelect),this.handleRouteChange())}disconnectedCallback(){this.handleOffersUpdated&&window.removeEventListener("offers-updated",this.handleOffersUpdated),window.removeEventListener("hashchange",this.handleRouteChange),this.removeEventListener("offer-select",this.handleOfferSelect)}render(){this.innerHTML=`
      <section class="offers-container">
        <div class="offers-row"></div>
      </section>
    `}set items(e){this.renderItems(e)}renderItems(e){let t=this.querySelector(".offers-row");t.innerHTML=e.map(Ae).join("")}handleOfferSelect(e){let t=document.querySelector("offer-modal");t&&t.show(e.detail)}onRouteChange(){if(location.hash!=="#home"&&location.hash!==""||this._loaded===!0)return;this._loaded=!0;let e=ve();this.renderItems(e),pe()}};customElements.get("offers-list")||customElements.define("offers-list",J);var O={single:"assets/img/document.svg",medium:"assets/img/tor.svg",large:"assets/img/box.svg"},Me=[{thumb:"assets/img/box.svg",title:"GL burger - 7-\u0440 \u0431\u0430\u0439\u0440 207",meta:"11/21/25 \u2022 14:00",price:"10,000\u20AE",sub:[{name:"\u0411\u0443\u0443\u0437",price:"5000\u20AE"},{name:"\u0421\u04AF\u04AF",price:"2000\u20AE"}]},{thumb:"assets/img/document.svg",title:"GL burger - 7-\u0440 \u0431\u0430\u0439\u0440 207",meta:"11/21/25 \u2022 14:00",price:"10,000\u20AE",sub:[{name:"\u0411\u0443\u0443\u0437",price:"5000\u20AE"},{name:"\u0421\u04AF\u04AF",price:"2000\u20AE"}]},{thumb:"assets/img/tor.svg",title:"GL burger - 7-\u0440 \u0431\u0430\u0439\u0440 207",meta:"11/21/25 \u2022 14:00",price:"10,000\u20AE",sub:[{name:"\u0411\u0443\u0443\u0437",price:"5000\u20AE"},{name:"\u0421\u04AF\u04AF",price:"2000\u20AE"}]},{thumb:"assets/img/tor.svg",title:"GL burger - 7-\u0440 \u0431\u0430\u0439\u0440 207",meta:"12/31/25 \u2022 22:20",price:"10,000\u20AE",sub:[{name:"\u0411\u0443\u0443\u0437",price:"5000\u20AE"},{name:"\u0421\u04AF\u04AF",price:"2000\u20AE"}]}];function Ae(o){let e=o.thumb||"assets/img/document.svg",t=o.title||"",r=o.meta||"",i=o.price||"",s=o.orderId||o.id||"",a=F(JSON.stringify(o.sub||[])),n=F(JSON.stringify(o.customer||{}));return`
    <offer-card
      thumb="${e}"
      title="${t}"
      meta="${r}"
  ...
  `}function fe(o){try{let e=String(o).split("\u2022"),[t,r]=e,[i,s,a]=t.split("/"),[n,d]=r.split(":"),l=2e3+Number.parseInt(a,10);return new Date(l,Number(i)-1,Number(s),Number(n),Number(d))}catch(e){console.error("date error shu:",e,o)}}function ge(o){let e=o?.scheduled_at;if(!e)return null;let t=Date.parse(e);if(!isNaN(t))return t;let r=fe(e);return r?r.getTime():null}function $e(o){let e=ge(o);return e?e<Date.now():!0}function qe(o){return o>5?O.large:o>=2?O.medium:o===1?O.single:O.large}function Re(o){let e=o?.from_name||"",t=o?.to_name||"";return[e,t].filter(r=>r!=="").join(" - ")}function Te(o){return o.filter(t=>{let r=t?.status;return r==="delivered"||r==="cancelled"||t?.courier?!1:!$e(t)}).map(t=>{let r=t?.items,i=r.reduce((n,d)=>n+(d?.qty??0),0),s=r.map(n=>({name:`${n?.name} x${n?.qty}`})),a=ge(t);return{orderId:t?.id||"",title:Re(t),meta:me(a),price:I(t?.total_amount),thumb:qe(i),customer:t?.customer,sub:s}})}async function _e(){let o=await m("/api/orders");if(!o.ok)return[];let e=await o.json();return Te(e)}function ve(){let o=localStorage.getItem("offers");if(!o)return[];try{return JSON.parse(o)||[]}catch{return[]}}function ye(o){let e=localStorage.getItem("authUserKey");return e?`${o}:${e}`:o}function De(){let o=localStorage.getItem(ye("removed_offer_ids"));if(!o)return[];try{return JSON.parse(o)||[]}catch{return[]}}function He(){let o=localStorage.getItem(ye("removed_offer_keys"));if(!o)return[];try{return JSON.parse(o)||[]}catch{return[]}}function Ne(o){let e=De(),t=He();return!e.length&&!t.length?o:o.filter(r=>{let i=r?.orderId||r?.id||null;if(i&&e.includes(String(i)))return!1;let s=`${r?.title||""}|${r?.meta||""}|${r?.price||""}`;return!t.includes(s)})}function Ue(o){return o.filter(e=>{if(!e?.meta)return!0;let t=fe(e.meta);return t?t.getTime()>=Date.now():!0})}async function pe(){let o=[];try{o=await _e()}catch{o=ve()}o.length||(o=Me),o=Ue(o),o=Ne(o),localStorage.setItem("offers",JSON.stringify(o)),document.querySelectorAll("offers-list").forEach(e=>{e.items=o})}var V=class extends HTMLElement{connectedCallback(){this.scheduleIdle=this.scheduleIdle?.bind(this)||(e=>{typeof window.requestIdleCallback=="function"?window.requestIdleCallback(()=>e(),{timeout:1200}):setTimeout(e,300)}),this.handleUpdate=this.handleUpdate.bind(this),this.handleClick=this.handleClick.bind(this),this.handleViewportChange=this.handleViewportChange.bind(this),this._loaded=!1,this.handleRouteChange=this.handleRouteChange?.bind(this)||(()=>this.onRouteChange()),this.render(),this.cacheEls(),this.addEventListener("click",this.handleClick),window.addEventListener("delivery-cart-updated",this.handleUpdate),window.addEventListener("hashchange",this.handleRouteChange),this.mediaQuery=window.matchMedia("(max-width: 900px)"),this.mediaQuery.addEventListener("change",this.handleViewportChange),this.handleViewportChange(),this.handleRouteChange()}disconnectedCallback(){window.removeEventListener("delivery-cart-updated",this.handleUpdate),window.removeEventListener("hashchange",this.handleRouteChange),this.removeEventListener("click",this.handleClick),this.mediaQuery&&this.mediaQuery.removeEventListener("change",this.handleViewportChange)}onRouteChange(){(location.hash||"#home")==="#home"&&(this._loaded||(this._loaded=!0,this.scheduleIdle(()=>this.load())))}render(){this.innerHTML=`
  ...
  <g id="Complete">
    ...
    `}escape(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;")}generateDisplayId(e,t){if(!e||!t)return"";let r=e.substring(0,3).toUpperCase(),i=t.substring(t.length-4);return`${r}${i}`}};customElements.define("couriers-card",ee);var te=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.value=0}connectedCallback(){let e=parseInt(this.getAttribute("max"))||5,t=this.getAttribute("color")||"gold",r=this.getAttribute("size")||"26px",i=document.createElement("style");i.textContent=`
      .rating {
        display: flex;
        gap: 5px;
        cursor: pointer;
